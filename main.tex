...
\textbf{Runge-Kutta Methods:} are a generalisation of collocation methods, since they don't have coefficients that rely on integrals of Lagrange polynomials, they can have any coefficients. A \textbf{Runge-Kutta} method is any method of form 
\begin{align*}
